...
app.use(cors());        // allow website to request resource from another domain(here connect frontend & backend)
...
/*we are sending data to mongodb atlas only single time & it has been sent */
